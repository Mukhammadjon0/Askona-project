            ...
            <div className="w-full flex flex-row items-center justify-between">
              <div className="flex flex-row items-center">
                <div className="flex flex-row items-center gap-10">
                  ...
                  <NavLink
                    className="flex items-center font-normal text-sm leading-4"
                    href="#!"
                  >
                    Минск{" "}
                    <BsChevronDown className="text-navTopbBg pl-2 text-3xl" />
                  </NavLink>
                  <p className="text-start flex items-center text-gray-400 text-sm">
                    Магазины:{" "}
                    <span className="font-bold text-black pl-2">30</span>
                  </p>
                  <Link to={'/'}>
                    <img className='' src={logoAksona} alt="logo" />
                  </Link>
                  ...
                  <div className="flex gap-8">
                    ...
                    <button className="rounded flex items-center border border-solid py-2 px-2 text-center">
                      <TbPhoneCall className="text-gray-400  pr-2 text-2xl" />{" "}
                      Перезвоните мне
                    </button>
                  </div>
                </div>
                <div className="flex ml-5 items-center">
                  ...
                  <div className='text-[#00B6C9] text-xs flex flex-col leading-4'>
