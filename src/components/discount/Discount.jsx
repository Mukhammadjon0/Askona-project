        ...
        <div className='Discount container'>
            ...
            >
                <SwiperSlide><div className="Address_shop">
                    ...
                    <button onClick={() => navigate('/location')} className="border-t-[1px] py-1 px-5 text-white rounded bg-[#00bac9] duration-200 hover:bg-[#0099a5] active:scale-95">{lang === 'ru' ? 'Показать на карте' : 'Xaritada ko`rsatish'}</button>
                </div>
                </SwiperSlide>
                <SwiperSlide>
                ...
                <SwiperSlide>
                    <div className="Selection_mattresses">
                        ...
                        <button onClick={() => navigate('/productCtg/6')} className="border-t-[1px] py-1 px-5 text-white rounded bg-[#00bac9] duration-200 hover:bg-[#0099a5] active:scale-95">{lang === 'ru' ? 'Подобрать опрыскиватель' : 'Purkagichni tanlang'}</button>
                    </div>
                </SwiperSlide>
            </Swiper>
