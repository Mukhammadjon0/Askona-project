    ...
    <div className='Contact_info'>
      ...
      <div className="Contact_info_df">
        <div className="Contact_info_df1">
          ...
          <a className='Contact_info_df_a' href="">Задать вопрос</a>
        </div>
        <div className="Contact_info_df2">
          ...
          <a className='Contact_info_df_a' href="">Позвонить по видео</a>
        </div>
        <div className="Contact_info_df3">
          ...
          <a className='Contact_info_df_a' href="">Открыть раздел</a>
        </div>
      </div>
    </div>
  )
