...
function SearchResult({ name_ru, name_uz, img, sub_ctg, prod_id, setSearchTerm }) {
    ...
    return (
        <div className='flex p-5 cursor-pointer justify-between items-center hover:text-[#407CD3] ' onClick={getDetail}>
            <img className='w-16' src={`https://api.basito.uz${img[0].img}`} alt="product" />
