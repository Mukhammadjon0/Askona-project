                        ...
                        >
                            <div className='bg-white desktop:w-[604px] tablet:w-[604px] mobile:w-screen h-full '>
                                ...
                                {/* <div className="flex flex-row justify-between px-6 py-5 border-t-[1px] border-gray-300">
                                    ...
                                    <span className='text-[#00B6C9] font-bold text-xl'>{basket?.summa?.toLocaleString("uz-UZ") || 0} {language?.summ}</span>
                                </div> */}
                                <div className="flex px-6 flex-row justify-between">
                                    <button onClick={handleNavigate} className='w-full text-gray-500 text-base border-[1px] border-gray-500 py-2 rounded bg-transparent duration-200 hover:bg-[#00B9C0] hover:border-[#00B9C0] hover:text-white active:scale-95'>{language?.kupit}</button>
