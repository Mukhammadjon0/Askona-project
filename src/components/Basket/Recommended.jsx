                    ...
                    <SwiperSlide key={item.id}>
                        <div className="pt-2 bg-white border-[1px] border-gray-200 rounded cursor-pointer text-start">
                            <div className="bg-white">
                                ...
                                }} style={{ backgroundImage: `url(http://api.basito.uz${item.images[0]})`, backgroundSize: 'cover' }} className='w-[246px] h-[128px] bg-center bg-no-repeat m-auto flex flex-col justify-between p-3'>
                                ...
                                <div className="border-t-[1px] border-gray-200 m-2 pt-2">
                                    ...
                                    <p className='font-medium text-xs text-gray-400 mt-2'>от <span className='text-[#00B9C0] text-sm font-bold'>{item.price.toLocaleString("uz-UZ")} BYN</span>  <span className='text-gray-400 line-through'>180 BYN</span></p>
                                </div>
                            </div>
                        </div>
                    </SwiperSlide>
